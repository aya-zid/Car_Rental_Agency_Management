...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow","Nouvelle adresse mail "))
        self.label_2.adjustSize()
        self.label_3.setText(_translate("MainWindow","Modfier l'adresse mail d'un client "))
    ...
    def lire(self):
        ...
        if(len(self.lineEdit_2.text())<15):
            self.label_8.setText("Adresse mail invalide")
            self.label_8.adjustSize()
        elif(((self.lineEdit_2.text()[-10:] )in l3 ==False)):
            if(self.lineEdit_2.text()[-11:]!=ad1):
                if(self.lineEdit_2.text()[-12:]!=ad2):
                    self.label_8.setText("Adresse mail invalide")
                    self.label_8.adjustSize()
