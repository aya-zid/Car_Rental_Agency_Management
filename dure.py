...
"")
        ...
        self.label_4.setGeometry(QtCore.QRect(50,330,201,31))
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow","Modifier la durée de location "))
        ...
        self.label_4.setText(_translate("MainWindow","nouvelle durée \n (par jour) : "))
    ...
    def lire(self):
        ...
        if ((self.label_6.text()=="")and(self.label_7.text()=="")and(self.label_8.text()=="")and((l in cle)==False)):
            msg=QMessageBox()
            msg.setWindowTitle("erreur")
            msg.setText("location introuvable")
            x=msg.exec_()
            box=1
        if ((self.label_6.text()=="")and(self.label_7.text()=="")and(self.label_8.text()=="")and(box==0)):
