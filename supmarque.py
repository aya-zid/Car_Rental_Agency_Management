...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow","Marque : "))
        self.label.adjustSize()
        self.label_3.setText(_translate("MainWindow","Suppresion d'une voiture"))
    ...
    def lire(self):
        ...
        for cle,valeur in d.items():
            if (valeur[0]==self.comboBox_2.currentText()):
                s.append(cle)
        if(len(s)==0):
            msg=QMessageBox()
            msg.setWindowTitle("Erreur")
            msg.setText("Marque introuvable")
            x=msg.exec_()
        else:
            for w in s:
                del d[w]
            ...
            msg.setText("Marque supprimée avec succés")
            x=msg.exec_()
