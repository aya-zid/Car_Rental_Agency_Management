...
"")
        ...
        self.label_5.setGeometry(QtCore.QRect(60,20,201,31))
        self.label_5.setFont(font_3)
        self.label_5.setObjectName("label_5")
        self.label_5.setStyleSheet("color : pink")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(70,115,500,23))
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(50,215,500,23))
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(30,315,500,23))
        ...
        self.label_6.setGeometry(QtCore.QRect(200,160,300,41))
        self.label_6.setFont(font_2)
        self.label_6.setObjectName("label_6")
        self.label_7 = QtWidgets.QLabel(self.centralwidget)
        self.label_7.setGeometry(QtCore.QRect(200,260,300,41))
        self.label_7.setFont(font_2)
        self.label_7.setObjectName("label_7")
        self.label_6.setStyleSheet("color : red")
        self.label_7.setStyleSheet("color : red")
        self.lineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit.setGeometry(QtCore.QRect(200,100,211,51))
        self.lineEdit.setFont(font)
        self.lineEdit.setObjectName("lineEdit")
        self.lineEdit.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"")
        self.lineEdit_2 = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_2.setGeometry(QtCore.QRect(200,200,211,51))
...
"")
        ...
        self.dateEdit.setGeometry(QtCore.QRect(200,300,211,51))
...
"")
        ...
        self.pushButton.setGeometry(QtCore.QRect(140,400,191,51))
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow"," Supression d'une location "))
        self.label_5.adjustSize()
        self.label_6.setText(_translate("MainWindow",""))
        self.label_6.adjustSize()
        self.label_7.setText(_translate("MainWindow",""))
        self.label_7.adjustSize()
        self.label_2.setText(_translate("MainWindow","CIN "))
        self.label_2.adjustSize()
        self.label_3.setText(_translate("MainWindow","Matricule "))
        self.label_3.adjustSize()
        self.label_4.setText(_translate("MainWindow","Date de location "))
    ...
    def lire(self):
        ...
        if ((self.label_6.text()=="")and(self.label_7.text()=="")and(box==0)):
            ...
            msg.setText("suppression effectuée avec succées")
            x=msg.exec_()
            box=1
