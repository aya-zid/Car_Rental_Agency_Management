...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow","Nouvelle adresse "))
        self.label_2.adjustSize()
        self.label_3.setText(_translate("MainWindow","Modfier l'adresse d'un client "))
    ...
    def lire(self):
        ...
        if(self.lineEdit_2.text().isalpha()==False):
            self.label_8.setText("Adresse invalide")
            self.label_8.adjustSize()
        elif(self.lineEdit_2.text()[0].isupper()==False):
            self.label_8.setText("L'adresse doit commencer par une majuscule ")
            self.label_8.adjustSize()
        else:
