...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow","Nouvelle couleur "))
        self.label_2.adjustSize()
        self.label_3.setText(_translate("MainWindow","Modfier la couleur d'une voiture "))
        ...
        if ((self.label_7.text()=="")and((self.lineEdit.text() in cle)==True)):
            ...
            for c,v in d.items():
                if (c==self.lineEdit.text()):
                    v[1]=self.comboBox_3.currentText()
