...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow","Nouveau téléphone "))
        self.label_2.adjustSize()
        self.label_3.setText(_translate("MainWindow","Modfier le téléphone d'un client "))
    ...
    def lire(self):
        ...
        if ((self.lineEdit.text().isnumeric()==False)or(len(self.lineEdit.text())!=8) or (self.lineEdit.text()=='00000000') or((self.lineEdit.text()[0] in l1)==False)):
            ...
            self.label_7.adjustSize()
        if ((self.lineEdit_2.text().isnumeric()==False)or(len(self.lineEdit_2.text())!=8) or((self.lineEdit_2.text()[0] in l2)==False)):
            self.label_8.setText("Numero invalide")
            self.label_8.adjustSize()
        else:
